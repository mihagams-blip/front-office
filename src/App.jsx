...
export default function App() {
  ...
  const startFranchise = (seasons) => { pingGame(); setG(freshSeason(1, { titles: { h: 0, a: 0 }, keepH: [], keepA: [], seasons, cum: { h: 0, a: 0 } })); setScreen("play"); setSel(null); setShowIntro(true); setLbSaved(false); };
